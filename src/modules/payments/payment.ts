...
// // Schema for managing payout details for service providers
...
//   provider: one(providers, {
//     fields: [payoutAccounts.providerId],
//     references: [providers.id],
//   }),
// }));

// // Schema for tracking payouts to service providers
...
//   ({ one }) => ({
//     provider: one(providers, {
//       fields: [paymentSettings.providerId],
//       references: [providers.id],
//     }),
//   })
// );
...
//     }),
//     provider: one(providers, {
//       fields: [paymentDisputes.providerId],
//       references: [providers.id],
//     }),
//   })
// );
